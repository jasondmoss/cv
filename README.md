...
That said, there are newer frameworks, libraries and buildtools that are absolutely phenomenal and certainly take development to the next level: [WordPress][2], [Craft CMS][3], [Laravel][4],  [Symfony][5], [JavaScript][6], [jQuery][7], [Vue][8], [Grunt][9].
